...
class TestMandateFieldsSchemaValidations:
    def test_campaign_config_with_only_mandate_fields_configuration(self,
        ...
        try:
            IterationValidation(**(valid_campaign_config_with_only_mandate_fields["Iterations"][0]))
    ...
    def test_missing_mandate_fields(self, mandate_field, valid_campaign_config_with_only_mandate_fields):
        data = valid_campaign_config_with_only_mandate_fields["Iterations"][0].copy()
    ...
    def test_valid_id(self, id_value, valid_campaign_config_with_only_mandate_fields):
        data = {**valid_campaign_config_with_only_mandate_fields["Iterations"][0], "ID": id_value}
    ...
    def test_valid_version(self, version_value, valid_campaign_config_with_only_mandate_fields):
        data = {**valid_campaign_config_with_only_mandate_fields["Iterations"][0], "Version": version_value}
        model = IterationValidation(**data)
    ...
    def test_valid_name(self, name_value, valid_campaign_config_with_only_mandate_fields):
        data = {**valid_campaign_config_with_only_mandate_fields["Iterations"][0], "Name": name_value}
        model = IterationValidation(**data)
        assert model.name == name_value

    # IterationDate
    @pytest.mark.parametrize("date_value", ["20250101", "20250215", "20250301"])
    def test_valid_iteration_date(self, date_value, valid_campaign_config_with_only_mandate_fields):
        data = {**valid_campaign_config_with_only_mandate_fields["Iterations"][0], "IterationDate": date_value}
        model = IterationValidation(**data)
    ...
    def test_valid_type(self, type_value, valid_campaign_config_with_only_mandate_fields):
        data = {**valid_campaign_config_with_only_mandate_fields["Iterations"][0], "Type": type_value}
        model = IterationValidation(**data)
    ...
    def test_valid_default_comms_routing(self, routing_value, valid_campaign_config_with_only_mandate_fields):
        data = {**valid_campaign_config_with_only_mandate_fields["Iterations"][0], "DefaultCommsRouting": routing_value}
        model = IterationValidation(**data)
        assert model.default_comms_routing == routing_value

    # DefaultNotEligibleRouting
    @pytest.mark.parametrize("routing_value", ["RouteB", "NotEligComm", "NoComms"])
    def test_valid_default_not_eligible_routing(self, routing_value, valid_campaign_config_with_only_mandate_fields):
        data = {**valid_campaign_config_with_only_mandate_fields["Iterations"][0],
    ...
    def test_valid_default_not_actionable_routing(self, routing_value, valid_campaign_config_with_only_mandate_fields):
        data = {**valid_campaign_config_with_only_mandate_fields["Iterations"][0],
...
class TestOptionalFieldsSchemaValidations:
    ...
    def test_iteration_number(self, iteration_number, valid_campaign_config_with_only_mandate_fields):
        data = {**valid_campaign_config_with_only_mandate_fields["Iterations"][0], "IterationNumber": iteration_number}
        model = IterationValidation(**data)
        assert model.iteration_number == iteration_number

    @pytest.mark.parametrize("approval_minimum", [0, 25, 99])
    def test_approval_minimum(self, approval_minimum, valid_campaign_config_with_only_mandate_fields):
        data = {**valid_campaign_config_with_only_mandate_fields["Iterations"][0], "ApprovalMinimum": approval_minimum}
        model = IterationValidation(**data)
        assert model.approval_minimum == approval_minimum

    @pytest.mark.parametrize("approval_maximum", [100, 250, 999])
    def test_approval_maximum(self, approval_maximum, valid_campaign_config_with_only_mandate_fields):
