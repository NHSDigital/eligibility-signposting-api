...
def test_get_person_cohorts_with_other_attribute_types_present(person_data_reader):
    data = Person(
        [
            {
                "ATTRIBUTE_TYPE": "COHORTS",
                "COHORT_MEMBERSHIPS": [{"COHORT_LABEL": "COHORT_F", "DATE_JOINED": "20231020"}],
            },
