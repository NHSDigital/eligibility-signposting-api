...
from eligibility_signposting_api.services.operators import Operator, OperatorRegistry
...
cases += [
    ...
    (None, RuleOperator.ne, "", True, ""),
    ("", RuleOperator.ne, "", False, ""),
    ("", RuleOperator.ne, "0", True, ""),
