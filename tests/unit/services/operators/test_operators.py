...
cases += [
    ...
    ("20240831", RuleOperator.gte, "20240901", False, "# Exclude if has had last invitation on or after 1st September 2024"),
    ("20240901", RuleOperator.gte, "20240901", True, "# Exclude if has had last invitation on or after 1st September 2024"),
    ("20240902", RuleOperator.gte, "20240901", True, "# Exclude if has had last invitation on or after 1st September 2024"),
]
...
cases += [
    ...
    ("19500616", RuleOperator.lte, "19500617", True, "Exclude 75 or older at campaign start date (All born on and before 17/06/1950)"),
    ("19500617", RuleOperator.lte, "19500617", True, "Exclude 75 or older at campaign start date (All born on and before 17/06/1950)"),
    ("19500618", RuleOperator.lte, "19500617", False, "Exclude 75 or older at campaign start date (All born before 17/06/1950)"),
]
...
cases += [
    ...
    ("20250123", RuleOperator.day_gt, "-91", False, "Exclude individuals who have completed Covid Vaccination less than 91 days ago"),
    ("20250124", RuleOperator.day_gt, "-91", False, "Exclude individuals who have completed Covid Vaccination less than 91 days ago"),
    ("20250125", RuleOperator.day_gt, "-91", True, "Exclude individuals who have completed Covid Vaccination less than 91 days ago"),
]
...
cases += [
    ...
    ("19090424", RuleOperator.year_lt, "-116", True, "Exclude anyone over 116 on the day from inclusion - 116 yesterday"),
    ("19090425", RuleOperator.year_lt, "-116", False, "Exclude anyone over 116 on the day from inclusion-  116 today"),
    ("19090426", RuleOperator.year_lt, "-116", False, "Exclude anyone over 116 on the day from inclusion - 116 tomorrow"),
]
